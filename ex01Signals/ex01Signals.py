...
def readSignals(file_path):
    ...
    with open(file_path) as file:
        ...
        #print(return_dict)
        print("# data import %s succesfull" % file_path)
        return return_dict
...
def plotSignal(sig_ele, sig_noi):
    ...
    """
    stages = len(sig_ele["amplitudes"])     # how many different signals will be calculated
...
if __name__ == "__main__":
    ...
    print("data import %s succesfull" % "noise.txt")
